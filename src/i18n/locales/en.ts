export const en = {
  ...
  balances: {
    ...
    enterAmount: "Enter current balance:",
    selectCurrency: "Select currency:",
    amount: "Amount:",
    select: "Select balance to edit:",
    ...
    transferAmount: "Enter transfer amount:",
    transferComplete: "✅ Transfer completed!",
    editNameTitle: "💳 *Edit Balance Name*",
    current: "Current:",
    enterNew: "Enter new name:",
    editAmountTitle: "💳 *Edit Balance Amount*",
  ...
  debts: {
    ...
    selectDebt: "Select debt to edit:",
    statusPending: "⏳",
    statusPaid: "✅",
    labelIOwe: "🔴 I owe",
    labelTheyOwe: "🟢 They owe me",
    due: "Due:",
    created: "✅ Debt recorded!",
    ...
    setDeadline: "📅 Set Deadline",
    changeDeadline: "📅 Change Deadline",
    enterDeadline: "Enter new deadline (DD.MM.YYYY):",
    deadlineExample: "Example: 31.12.2026",
    removePrompt: "Or tap 🗑 Remove to delete deadline.",
    skipPrompt: "Or tap ⏩ Skip to cancel.",
    markPaidTitle: "✅ Mark debt as paid?",
    debtName: "Debt:",
    actionWill: "This action will:",
    willMarkPaid: "• Mark the debt as PAID",
    willRemove: "• Remove it from active debts",
    yesMarkPaid: "✅ Yes, Mark as Paid",
    setDueDate: "📅 Set Due Date",
    changeDueDate: "📅 Change Due Date",
    setDueDateTitle: "📅 *Set Due Date*",
    changeDueDateTitle: "📅 *Change Due Date*",
    enterDueDate: "Enter new due date (DD.MM.YYYY):",
    dueDateExample: "Example: 31.12.2026",
    removeDueDatePrompt: "Or tap 🗑 Remove Date to delete due date.",
    disableReminders: "🔕 Disable Reminders",
    remindersDisabled: "✅ Reminders disabled and due date removed.",
    enableAutoPayment: "✅ Enable Auto-Payment",
    disableAutoPayment: "❌ Disable Auto-Payment",
    autoPaymentComingSoon: "⚠️ Auto-payment feature is coming soon!",
    payTo: "💸 Pay to",
    getPaidFrom: "💰 Get paid from",
  ...
  goals: {
    ...
    achieved: "Achieved:",
    selectCompleted: "✅ Goal: {name}",
    enterName: "Enter goal name (e.g., Vacation, New Phone):",
    enterTarget: "Enter target amount:",
    enterCurrent: "Enter current amount (optional):",
    enterFormat: "Enter goal in format:",
    formatExample: "`GoalName amount CURRENCY`",
    examples: "*Examples:*",
    ...
    enterNewTarget: "Enter new target amount:",
    ...
    willMove: "• Move it to completed goals",
    yesMarkCompleted: "✅ Yes, Mark as Completed",
    setDeadlineBtn: "📅 Set Deadline",
    changeDeadlineBtn: "📅 Change Deadline",
    setDeadlineTitle: "📅 *Set Deadline*",
    changeDeadlineTitle: "📅 *Change Deadline*",
    enterDeadline: "Enter new deadline (DD.MM.YYYY):",
    deadlineExample: "Example: 31.12.2026",
    removeDeadlinePrompt: "Or tap 🗑 Remove Date to delete deadline.",
    disableReminders: "🔕 Disable Reminders",
  ...
  common: {
    ...
    notFound: "❌ Not found",
    selectAccount: "💳 Select account:",
    enterDay: "📅 *Enter day of month (1-31):*",
    ...
    analyticsViewInsights: "📊 *Analytics*\n\nView your financial insights:",
    analyticsSelectWhatToSee: "📊 *Analytics*\n\nSelect what you want to see:",
    automationManage: "🤖 *Automation*\n\nManage automated features:",
    queryPerformanceReport: "🔍 *Query Performance Report*\n\n",
    incomePlanVsActual: "💵 *Income Plan vs Actual*\n\nExpected:\n",
    financialGoals: "🎯 *Your Financial Goals*\n\n",
    ...
    selectAccountPayment: "💳 Select account for payment:",
    ...
    checkingRecurringTransactions: "🔄 Checking recurring transactions...",
    checkingAutoDeposits: "💰 Checking auto-deposits...",
    checkingAutoIncomes: "💼 Checking auto-incomes...",
    checkingAutoDebtPayments: "💸 Checking auto-debt-payments...",
  },
  ...
  errors: {
    ...
    templateMissing: "❌ Template ID missing.",
  ...
  quickStart: {
    ...
    step3: "3️⃣ Enter account name and amount",
  },
  ...
  voice: {
    ...
    recognized: "🎤 Voice message recognized:",
