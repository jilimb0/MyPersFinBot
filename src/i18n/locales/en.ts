export const en = {
  ...
  goals: {
    depositSuccess: '✅ 🎯 Deposited {amount} to "{name}" from {account}!',
    addGoal: "✨ Add Goal",
  ...
  settings: {
    ...
    subscriptionExpiresLine: "Valid until: *{date}*",
    subscriptionRemainingLine: "Remaining: *{value}*",
    subscriptionRemainingValue: "{days}d {hours}h {minutes}m",
    subscriptionHint: "Manage your trial and Premium access here.",
    resumeSubscription: "▶️ Resume subscription",
    subscriptionResumed: "Subscription resumed",
    cancelSubscription: "🛑 Pause subscription",
    cancelSubscriptionPrompt:
      "Pause subscription now?\n\nYour remaining access time will be saved and can be added to your next purchase.",
    cancelSubscriptionConfirm: "✅ Yes, pause",
    cancelSubscriptionAbort: "No",
    cancelSubscriptionDone:
      "Subscription paused. Remaining access time has been saved.",
    cancelSubscriptionDoneUntil:
      "Subscription paused. Saved access until {date}.",
    subscriptionRefresh: "🔄 Refresh status",
  ...
  commands: {
    ...
    monetization: {
      ...
      tierTrial: "Trial",
      tierPremium: "Premium",
      tierPaused: "Paused (saved time)",
      planFree: "🆓 *Current plan:* Free",
      planTrial: "🎁 *Current plan:* Trial",
      planPremium: "💎 *Current plan:* Premium",
      expires: "Expires",
      buyNow: "Buy now",
      paymentsDisabled:
      ...
      trialStartedTitle: "🎁 Trial activated!",
      trialStartedBody: "You now have full Premium access until {date}.",
      trialWhatIncluded:
        "Unlocked now:\n• Unlimited transactions\n• Unlimited voice input\n• Charts and advanced analytics\n• Statement import/export and automation",
      trialUnavailable: "Trial is not available",
      trialConfirmPrompt:
        "🎁 Start a free trial now?\n\nYou will get full Premium access for {trialDays} days.",
      trialConfirmButton: "✅ Start trial",
      trialCancelButton: "Cancel",
      trialCancelled: "Trial activation cancelled.",
      trialAlreadyActive: "🎁 Trial is already active until {date}.",
      ...
      featureTemplates: "Transaction templates",
      featureRecurring: "Recurring transactions",
      featureCustomMessages: "Custom reminder templates",
      featureExport: "Data export",
      featureAdvancedAnalytics: "Advanced analytics",
      featureStatementImport: "Bank statement import",
      featureVoice: "Voice input",
      featureCommandMode: "Command mode (/expense, /income, /search, etc.)",
      featureCharts: "Charts",
      chartPremiumOnly: "📊 Charts are a Premium feature.",
      chartUsage:
