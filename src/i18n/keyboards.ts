 ...
 */
export function getMainMenuKeyboard(lang: Language): TelegramBot.SendMessageOptions {
  return {
    reply_markup: {
      keyboard: [
        [
 ...
 */
export function getSettingsKeyboard(lang: Language): TelegramBot.ReplyKeyboardMarkup {
  return {
    keyboard: [
      [{ text: t(lang, 'settings.language') }],
      [{ text: t(lang, 'settings.changeCurrency') }],
      [{ text: t(lang, 'settings.incomeSources') }],
      [{ text: t(lang, 'settings.automation') }, { text: t(lang, 'settings.advanced') }],
      [{ text: t(lang, 'settings.helpInfo') }, { text: t(lang, 'mainMenu.mainMenuButton') }],
    ],
    resize_keyboard: true,
  }
}
 ...
 */
export function getAnalyticsKeyboard(lang: Language): TelegramBot.ReplyKeyboardMarkup {
  return {
    keyboard: [
 ...
 */
export function getStatsKeyboard(lang: Language): TelegramBot.ReplyKeyboardMarkup {
  return {
    keyboard: [
 ...
 */
export function getBackAndMainKeyboard(lang: Language): TelegramBot.ReplyKeyboardMarkup {
  return {
 ...
 */
export function getDateKeyboard(lang: Language): TelegramBot.ReplyKeyboardMarkup {
  return {
    keyboard: [
 ...
 */
export function getConfirmKeyboard(lang: Language): TelegramBot.ReplyKeyboardMarkup {
  return {
    keyboard: [
 ...
 */
export function getLanguageKeyboard(lang: Language): TelegramBot.ReplyKeyboardMarkup {
  return {
    keyboard: [
      [{ text: '🇬🇧 English' }],
      [{ text: '🇷🇺 Русский' }],
 ...
 */
export function getStartTrackingKeyboard(lang: Language): TelegramBot.ReplyKeyboardMarkup {
  return {
 ...
 */
export function getGoToBalancesKeyboard(lang: Language): TelegramBot.ReplyKeyboardMarkup {
  return {
    keyboard: [
